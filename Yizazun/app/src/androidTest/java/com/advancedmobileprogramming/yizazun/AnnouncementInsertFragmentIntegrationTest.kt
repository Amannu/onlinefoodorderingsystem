...
class AnnouncementInsertFragmentIntegrationTest{
    ...
    fun testStaticLabels(){
        Espresso.onView(ViewMatchers.withId(R.id.AnnouncementDescription))
            .check(ViewAssertions.matches(ViewMatchers.withText("Description")))
        Espresso.onView(ViewMatchers.withId(R.id.amount))
            .check(ViewAssertions.matches(ViewMatchers.withText("Announcement name")))
