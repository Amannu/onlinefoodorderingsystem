...
class FoodInsertFragmentIntegrationTest{
    ...
    fun testStaticLabels(){
        Espresso.onView(ViewMatchers.withId(R.id.foodDescription))
            .check(ViewAssertions.matches(ViewMatchers.withText("Description")))
        Espresso.onView(ViewMatchers.withId(R.id.amount))
            .check(ViewAssertions.matches(ViewMatchers.withText("food name")))
