...
class DrinkInsertFragmentIntegrationTest{
    ...
    fun testStaticLabels(){
        Espresso.onView(ViewMatchers.withId(R.id.DrinkDescription))
            .check(ViewAssertions.matches(ViewMatchers.withText("Description")))
        Espresso.onView(ViewMatchers.withId(R.id.amount))
            .check(ViewAssertions.matches(ViewMatchers.withText("Drink name")))
