...
class SpecialOfferInsertFragmentIntegrationTest{
    ...
    fun testStaticLabels(){
        Espresso.onView(ViewMatchers.withId(R.id.SpecialOfferDescription))
            .check(ViewAssertions.matches(ViewMatchers.withText("Description")))
        Espresso.onView(ViewMatchers.withId(R.id.amount))
            .check(ViewAssertions.matches(ViewMatchers.withText("SpecialOffer name")))
